...
<head>
  ...
  <title>SIPAE-Secretaría de Educación</title>
  ...
  <nav class="navbar  navbar-toggleable-md navbar-inverse bg-primary ">
    ...
    <nav class="navbar navbar-inverse bg-primary ">
      ...
      <ul class="navbar-nav ">
        ...
        <li class="nav-item">
          <a class="nav-link" href="">Cargar Listados</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="">Informes de Asistencias</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="">Informes Alimentarios</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="">Informes de certificación</a>
        </li>
        <li class="nav-item ">
